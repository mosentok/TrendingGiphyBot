...
public class PostingHoursButtonInteractionModule(ITrendingGiphyBotDbContext _trendingGiphyBotContext) : InteractionModuleBase<SocketInteractionContext<SocketMessageComponent>>
{
    ...
    public async Task OpenKeywordModalAsync()
    {
        ...
        var postingHooursModal = new ModalBuilder()
            ...
            .AddTextInput("Time Zone UTC Offset (+/-ab:xy)", "trending-posting-hours-utc-offset-text-input", placeholder: "-12:00, -3:30, +6:00", maxLength: 6, required: false, value: channelSettings.UtcOffset?.ToString() ?? string.Empty)
            .Build();
