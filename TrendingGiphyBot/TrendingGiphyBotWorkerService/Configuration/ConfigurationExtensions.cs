...
public static class ConfigurationExtensions
{
	...
	public static T GetRequiredConfiguration<T>(this IConfiguration configuration, string key) => configuration.GetOptionalConfiguration<T>(key) ?? throw new MissingConfigurationException();
