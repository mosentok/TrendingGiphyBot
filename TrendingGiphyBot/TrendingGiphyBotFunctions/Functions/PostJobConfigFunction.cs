...
namespace TrendingGiphyBotFunctions.Functions
{
    public class PostJobConfigFunction
    {
        ...
        public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = "jobconfigs/{channelid:decimal}")] JobConfigContainer container, decimal channelId, ILogger log)
        {
