...
[Migration("20260208002611_GifSources")]
partial class GifSources
{
    /// <inheritdoc />
        ...
        modelBuilder.Entity("TrendingGiphyBotWorkerService.ChannelSettings.KlipyPost", b =>
            {
                ...
                b.Property<ulong>("ChannelSettingsChannelId")
                    .HasColumnType("INTEGER");
                ...
                b.HasIndex("ChannelSettingsChannelId");
        ...
        modelBuilder.Entity("TrendingGiphyBotWorkerService.ChannelSettings.KlipyPost", b =>
            {
                b.HasOne("TrendingGiphyBotWorkerService.ChannelSettings.ChannelSettingsModel", "ChannelSettings")
                    .WithMany("KlipyPosts")
                    .HasForeignKey("ChannelSettingsChannelId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();
